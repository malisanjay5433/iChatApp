...
class iChatLoginController: UIViewController,UITextFieldDelegate {
    ...
    let nameTextField: DesignableTextField = {
        let tf = DesignableTextField()
        tf.placeholder = "Name"
...
//        
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor.init(hex: "f8f16d")
